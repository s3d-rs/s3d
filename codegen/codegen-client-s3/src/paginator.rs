...
pub struct ListObjectsV2Paginator<C, M, R = aws_smithy_client::retry::Standard> {
    handle: std::sync::Arc<crate::client::Handle<C, M, R>>,
    builder: crate::input::list_objects_v2_input::Builder,
}

impl<C, M, R> ListObjectsV2Paginator<C, M, R>
where
...
pub struct ListPartsPaginator<C, M, R = aws_smithy_client::retry::Standard> {
    handle: std::sync::Arc<crate::client::Handle<C, M, R>>,
...
pub struct ListPartsPaginatorItems<C, M, R = aws_smithy_client::retry::Standard>(
